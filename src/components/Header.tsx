  ...
  return (
    <header className="relative overflow-hidden bg-[#F1F8F4] pt-8 md:pt-12 pb-20 lg:pb-28 font-sans pcb-grid-pattern">
      ...
      <div className="relative mx-auto max-w-5xl px-6 text-center z-10">
        ...
        <div 
          data-aos="fade-down"
          className="inline-flex items-center gap-2 rounded-full border border-pcb-green/30 bg-white px-4.5 py-2 text-xs font-bold tracking-wide text-pcb-green-dark shadow-sm"
        >
        ...
        <div className="relative mt-10 max-w-4xl mx-auto">
          ...
          <blockquote className="relative px-4">
            <h1 
              data-aos="fade-up"
              data-aos-delay="100"
              className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl md:text-5xl lg:text-6xl leading-[1.15] drop-shadow-sm"
            >
        ...
        <p 
          data-aos="fade-up"
          data-aos-delay="300"
          className="mx-auto mt-8 max-w-2xl text-base text-gray-700 sm:text-lg font-medium leading-relaxed"
        >
        ...
        >
          <Link
            href="/contactPage"
            className="group relative flex w-full sm:w-auto items-center justify-center gap-2 rounded-xl bg-pcb-green px-8 py-4 text-base font-bold text-white shadow-lg shadow-pcb-green/25 transition-all duration-300 hover:-translate-y-0.5 hover:bg-pcb-green-dark hover:shadow-xl active:translate-y-0"
          >
            Get Instant Quote
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="mt-20 grid grid-cols-1 gap-6 sm:grid-cols-3">
          ...
          <div 
            data-aos="fade-up"
            data-aos-delay="100"
            className="group relative rounded-2xl border border-gray-200/60 bg-white/70 backdrop-blur-sm p-6.5 text-left shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-pcb-green/40 hover:bg-white hover:shadow-md"
          >
